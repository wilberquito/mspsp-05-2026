#ifndef MSPSPTIMEPBENCODING_DEFINITION
#define MSPSPTIMEPBENCODING_DEFINITION
...
class MSPSPTimePBEncoding : public MSPSPEncoding {
private:
...
MSPSPTimePBEncoding(MSPSP * instance, SolvingArguments * sargs, Arguments<ProgramArg> * pargs);
	~MSPSPTimePBEncoding();
