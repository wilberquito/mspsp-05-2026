#ifndef MSPSPTASKCOMBINATIONSENCODING2_DEFINITION
#define MSPSPTASKCOMBINATIONSENCODING2_DEFINITION
...
class MSPSPTaskCombinationsEncoding2 : public MSPSPEncoding {
private:
...
public:
	...
	MSPSPTaskCombinationsEncoding2(MSPSP * instance, SolvingArguments * sargs, Arguments<ProgramArg> * pargs);
	~MSPSPTaskCombinationsEncoding2();
