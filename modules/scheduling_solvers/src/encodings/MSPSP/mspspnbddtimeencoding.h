#ifndef MSPSPNBDDTIMEENCODING_DEFINITION
#define MSPSPNBDDTIMEENCODING_DEFINITION
...
class MSPSPNBDDTimeEncoding : public MSPSPEncoding {
private:
...
public:
	...
	MSPSPNBDDTimeEncoding(MSPSP * instance, SolvingArguments * sargs, Arguments<ProgramArg> * pargs);
	~MSPSPNBDDTimeEncoding();
