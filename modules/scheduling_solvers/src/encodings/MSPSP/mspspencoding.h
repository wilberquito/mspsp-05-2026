...
protected:
	...
	MSPSPModel _makeModel(const EncodedFormula & ef, const vector<bool> & bmodel) const;
...
public:
	...
	virtual MSPSPModel makeModel(const EncodedFormula & ef, const istream & bmodel) const;

	void printSolution(ostream & os, const MSPSPModel & model) const;
};
