#ifndef MSPSPTIMEOPBENCODING_DEFINITION
#define MSPSPTIMEOPBENCODING_DEFINITION
...
class MSPSPTimeOPBEncoding : public MSPSPEncoding {
private:
...
MSPSPTimeOPBEncoding(MSPSP * instance, SolvingArguments * sargs, Arguments<ProgramArg> * pargs);
	~MSPSPTimeOPBEncoding();
